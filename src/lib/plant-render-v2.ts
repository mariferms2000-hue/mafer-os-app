...
> = {
  ...
  monstera: {
    // pocas hojas, pero enormes e icónicas en peciolos largos — protagonismo
    // de la hoja fenestrada, no de la cantidad.
    maxLeanDeg: 8,
    height: [0.72, 0.96],
    stemCount: [1, 2],
    thickness: [0.13, 0.2],
    curvature: [0.22, 0.48],
    branchCount: [2, 4],
    branchAngleDeg: [30, 52],
    branchLengthRatio: [0.5, 0.72],
    arrangement: "alterna",
    leafCountAdult: [3, 5],
    leafSizeRatio: [0.32, 0.44],
    density: [0.35, 0.55],
    crownWidthRatio: [0.85, 1.15],
  ...
  lavanda: {
    // menos varas, mejor separadas: silueta refinada en vez de amontonada.
    maxLeanDeg: 7,
    height: [0.62, 0.86],
    stemCount: [4, 7],
    ...
    arrangement: "opuesta",
    leafCountAdult: [14, 22],
    leafSizeRatio: [0.04, 0.07],
    density: [0.5, 0.75],
    crownWidthRatio: [0.6, 0.85],
    stemHeightRatio: [0.15, 0.28],
  },
  olivo: {
    // copa baja, redondeada y densa — el tronco cede protagonismo a una
    // copa ancha; se diferencia del eucalipto por ser más bajo y compacto.
    maxLeanDeg: 10,
    height: [0.74, 0.92],
    stemCount: [1, 1],
    thickness: [0.18, 0.28],
    curvature: [0.35, 0.62],
    branchCount: [5, 8],
    branchAngleDeg: [42, 66],
    branchLengthRatio: [0.36, 0.56],
    arrangement: "alterna",
    leafCountAdult: [26, 40],
    leafSizeRatio: [0.045, 0.07],
    density: [0.55, 0.78],
    crownWidthRatio: [0.85, 1.15],
    stemHeightRatio: [0.28, 0.4],
  },
  bambu: {
  ...
  potos: {
    // trailing: sube un poco desde la tierra y luego cae en cascada por
    // debajo de la línea de tierra — la silueta más claramente «colgante»
    // del set, no una que se arrastra hacia los lados.
    maxLeanDeg: 10,
    height: [0.32, 0.48],
    stemCount: [2, 3],
    thickness: [0.05, 0.08],
    ...
    leafSizeRatio: [0.1, 0.15],
    density: [0.55, 0.8],
    crownWidthRatio: [0.55, 0.8],
  ...
  pilea: {
    // «moneditas»: pocas hojas grandes y bien redondas en un ramillete alto,
    // no muchas hojas pequeñas repartidas por un tallo largo.
    maxLeanDeg: 6,
    height: [0.35, 0.5],
    stemCount: [1, 1],
    thickness: [0.08, 0.12],
    ...
    branchLengthRatio: [0.4, 0.62],
    arrangement: "alterna",
    leafCountAdult: [6, 9],
    leafSizeRatio: [0.16, 0.22],
    density: [0.4, 0.6],
    crownWidthRatio: [0.95, 1.25],
    stemHeightRatio: [0.55, 0.7],
  },
  palmera: {
    // tronco único y alto, corona LIMPIA de pocas frondas bien espaciadas —
    // menos frondas que antes para leerse elegante, no desordenada.
    maxLeanDeg: 8,
    height: [0.9, 1.0],
    stemCount: [1, 1],
    thickness: [0.12, 0.18],
    curvature: [0.16, 0.32],
    branchCount: [5, 7], // frondas
    branchAngleDeg: [55, 78],
    branchLengthRatio: [0.42, 0.58],
    arrangement: "corona",
    leafCountAdult: [5, 7],
    leafSizeRatio: [0.3, 0.4],
    density: [0.5, 0.7],
    crownWidthRatio: [0.9, 1.15],
    stemHeightRatio: [0.72, 0.88],
  },
  eucalipto: {
    // árbol alto, abierto y aireado: tronco desnudo largo, copa angosta y
    // ramas rectas y ascendentes — opuesto a la copa baja y redonda del olivo.
    maxLeanDeg: 7,
    height: [0.88, 1.0],
    stemCount: [1, 1],
    thickness: [0.13, 0.18],
    curvature: [0.1, 0.24],
    branchCount: [4, 6],
    branchAngleDeg: [50, 72],
    branchLengthRatio: [0.3, 0.46],
    arrangement: "alterna",
    leafCountAdult: [14, 22],
    leafSizeRatio: [0.03, 0.05],
    density: [0.2, 0.38],
    crownWidthRatio: [0.4, 0.6],
    stemHeightRatio: [0.58, 0.72],
  },
};
