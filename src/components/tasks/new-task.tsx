    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg text-forest-deep">Nueva tarea</h2>
        ...
        >
          <div>
            ...
            <input id="nt-title" name="title" className="input" required autoFocus data-testid="new-task-title" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="label" htmlFor="nt-duration">Duración estimada</label>
              <select id="nt-duration" name="duration" className="select" defaultValue="">
          ...
          {more && (
            <div className="flex flex-col gap-3 border-t border-beige pt-3">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="label" htmlFor="nt-energy">Energía necesaria</label>
                  <select id="nt-energy" name="energy" className="select" defaultValue="">
                    <option value="">—</option>
                    <option value="baja">Baja</option>
                    <option value="media">Media</option>
                    <option value="alta">Alta</option>
              ...
              <p className="text-xs text-stone-soft">
                La checklist y los enlaces se agregan abriendo la tarjeta después de crearla.
              </p>
            </div>
          )}
